...
### A. Compact Proton Accelerator

::: {.pair}
::: {.pair-text}

The **Dielectric Wall Accelerator (DWA)** project at *UHN – Princess Margaret Cancer Centre* aims to design and develop compact proton accelerator for proton therapy. 
This study focuses on building waveguides models and beam physics to manage the complex synchronization required for high-gradient acceleration - towards an energy goal of 250 MeV.

:::
::: {.pair-media}
![Dynamic visualization of DWA modules firing in synchronization with the proton bunch.](photos/dwa_beamline_anim.gif){width=100% fig-alt="DWA Beamline Animation"}
:::
:::

- **Linear Optics Simulation:** Implementing model in **Transoptr** (Fortran) that supports "cells" of multiple firing modules, including realistic spatial gaps.
- **Phasing Algorithm:** Numerical root-finding approach to synchronize the nanosecond-scale pulsed electric fields with the traveling proton bunch. This ensures that the reference particle always sees the peak accelerating field as it traverses each module.
- **Energy Switch Mode:** Built a dynamic control interface in **pyoptr** to scale the peak electric field ($E_z$) of individual modules independently. This allows for rapid, pulse-to-pulse energy modulation of the proton beam.

---

### B. CT ↔ MC Model Training (Continued work from Ffmcbct)
...
### C. Fluence-Field-Modulated CBCT (FFM-CBCT)
...
:::
::: {.pair-media}
![Custom 3D Viewer: CT of a Cabbage](photos/3dviewer.gif){width=100% fig-alt="3D view of Cabbage CT"}
:::
:::
...
<!--
And here's the [abstract](https://aapm2025explorer-production.up.railway.app/detail/971)
-->
...
### D. Muon Spectroscopy & Beamline Simulation (TRIUMF)
...
::: {.pair}
::: {.pair-media}
![Grav Field Visualized](photos/grav.mp4){width=100% poster="photos/grav_thumb.png"}
:::
::: {.pair-text}
1. Descriptions to be added ...
:::
:::

::: {.pair}
::: {.pair-media}
![Chen Lee Attractor](photos/ChenLeeAnimated1.mp4){width=100% poster="photos/chenlee_thumb.png"}
:::
::: {.pair-text}
2. Descriptions to be added ...
:::
:::

::: {.pair}
::: {.pair-media}
![Rossler Attractor](photos/Rossler_attractor.mp4){width=100% poster="photos/rossler_thumb.png"}
:::
::: {.pair-text}
3. Descriptions to be added ...
:::
:::
